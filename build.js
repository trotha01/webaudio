...
var _user$project$Oscillator$update = F2(
	function (msg, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: model,
			_1: _user$project$Oscillator$play(model)
		};
	});
var _user$project$Oscillator$logExternalOut = _elm_lang$core$Native_Platform.outgoingPort(
	'logExternalOut',
	function (v) {
		return v;
	});
var _user$project$Oscillator$soundData = _elm_lang$core$Native_Platform.incomingPort(
	'soundData',
...
var _user$project$Oscillator$Play = {ctor: 'Play'};
	...
	return A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				{
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$toFloat(moveLeft),
					_1: 0
				},
...
var _user$project$Visualizer$Oscillator = F2(
	function (a, b) {
		return {id: a, model: b};
	});
var _user$project$Visualizer$SubMsg = function (a) {
	return {ctor: 'SubMsg', _0: a};
};
var _user$project$Visualizer$update = F2(
	function (msg, model) {
		var oscillator = _user$project$Oscillator$init(440);
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'PlaySound':
				var _p1 = A2(_user$project$Oscillator$update, _user$project$Oscillator$Play, oscillator);
				var newOscillator = _p1._0;
				var msg = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Visualizer$SubMsg, msg)
				};
			case 'SoundData':
				return {
					ctor: '_Tuple2',
...
var _user$project$Visualizer$subHelp = function (_p2) {
	var _p3 = _p2;
	return _user$project$Oscillator$subscriptions(
		function (data) {
			return _user$project$Visualizer$SoundData(data);
		});
};
var _user$project$Visualizer$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		A2(_elm_lang$core$List$map, _user$project$Visualizer$subHelp, model.oscillators));
};
